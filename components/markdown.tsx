...
const components: Partial<Components> = {
  ...
  blockquote: ({ node, children, ...props }) => (
    <blockquote
      className="border-l-2 border-zinc-200 dark:border-zinc-700 pl-2 md:pl-3 my-1.5 italic text-zinc-600 dark:text-zinc-400 text-sm sm:text-base"
      {...props}
    >
      {children}
    </blockquote>
  ...
  a: ({ node, children, ...props }) => (
    ...
    <Link
      className="text-blue-500 hover:underline hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 transition-colors break-words"
      target="_blank"
      rel="noreferrer"
      {...props}
    >
  ...
  h1: ({ node, children, ...props }) => (
    <h1
      className="text-xl md:text-2xl font-semibold mt-3 mb-1.5 text-zinc-800 dark:text-zinc-200 break-words"
      {...props}
    >
      {children}
    </h1>
  ...
  h2: ({ node, children, ...props }) => (
    <h2
      className="text-lg md:text-xl font-semibold mt-2.5 mb-1.5 text-zinc-800 dark:text-zinc-200 break-words"
      {...props}
    >
      {children}
    </h2>
  ...
  h3: ({ node, children, ...props }) => (
    <h3
      className="text-base md:text-lg font-semibold mt-2 mb-1 text-zinc-800 dark:text-zinc-200 break-words"
      {...props}
    >
      {children}
    </h3>
  ...
  h4: ({ node, children, ...props }) => (
    <h4
      className="text-sm md:text-base font-semibold mt-2 mb-1 text-zinc-800 dark:text-zinc-200 break-words"
      {...props}
    >
      {children}
    </h4>
  ...
  h5: ({ node, children, ...props }) => (
    <h5
      className="text-xs md:text-sm font-semibold mt-2 mb-1 text-zinc-800 dark:text-zinc-200 break-words"
      {...props}
    >
      {children}
    </h5>
  ...
  h6: ({ node, children, ...props }) => (
    <h6
      className="text-xs font-semibold mt-2 mb-0.5 text-zinc-800 dark:text-zinc-200 break-words"
      {...props}
    >
      {children}
    </h6>
  ...
  table: ({ node, children, ...props }) => (
    <div className="my-1.5 overflow-x-auto w-full max-w-full">
      <table
        className="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700 text-sm"
        {...props}
      >
        {children}
      </table>
  ...
  tbody: ({ node, children, ...props }) => (
    <tbody
      className="divide-y divide-zinc-200 dark:divide-zinc-700 bg-white dark:bg-transparent"
      {...props}
    >
      {children}
    </tbody>
  ...
  th: ({ node, children, ...props }) => (
    <th
      className="px-3 py-1.5 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider"
      {...props}
    >
      {children}
    </th>
